...
protoc -I. -I../../proto/bbq  --ts_proto_out=. --ts_proto_opt=outputServices=nice-grpc,outputServices=generic-definitions,outputClientImpl=true,oneof=unions,snakeToCamel=false,useExactTypes=false ./exam.proto

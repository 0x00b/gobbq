...
var registeredCompressor = make(map[bbq.CompressType]Compressor)
...
func GetCompressor(name bbq.CompressType) Compressor {
...
type Codec interface {
	...
	Type() bbq.ContentType
}

var registeredCodecs = make(map[bbq.ContentType]Codec)
...
func GetCodec(contentType bbq.ContentType) Codec {

...
import (
	...
	"github.com/0x00b/gobbq/cmd/bbq/proto/com/gorewriter/code"
...
func Prune(filename string, src []byte, packages *code.Packages) ([]byte, error) {
	...
	return imports.Process(filename, buf.Bytes(), &imports.Options{FormatOnly: true, Comments: true, TabIndent: true,
		TabWidth: 8})
}
